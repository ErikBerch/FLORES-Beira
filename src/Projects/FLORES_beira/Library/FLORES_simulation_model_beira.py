...
from simulation_data_beira import load_hydraulic_conditions, get_hydraulic_boundary_conditions, \
...
time_prep = timer()
basins_master = load_basins("input_data/region_layout_basins.csv",
                            "input_data/urban_development_scenarios.csv")  # Regional Layout
layers_master = load_layers("input_data/region_layout_layers.csv", basins_master)
all_measures_master = load_measures("input_data/flood_risk_reduction_measures.csv")
hydraulic_conditions_master = load_hydraulic_conditions("input_data/hydraulic_boundary_conditions_surge_beira.csv",
                                                        "input_data/hydraulic_boundary_conditions_rain_beira.csv")

damage_curves = load_damage_curves('input_data/global_flood_depth-damage_functions__30102017.xlsx', 'AFRICA',
                                   'Mozambique', 'Object based', 1.30)
load_basin_borders(basins_master, "input_data/region_layout_basin_borders.csv")
drainage_master = load_drainage_capacities(basins_master, 'input_data/basins_drainage.csv', small_channel=6,
