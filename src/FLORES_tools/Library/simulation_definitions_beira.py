...
class StructuralMeasure(object):
    ...
    def __init__(self, name, layer, loc, cconstant, cvariable, pot_heights, repfactor, breachfactor, htunit="m +MSL",
                 slope="None", irribaren="None", costunit='Million', add_strength=1.0):
        """
        ...
        self.StructureHeights = pot_heights
...
class StructuralMeasureLand(StructuralMeasure):
    ...
    def __init__(self, name, layer, loc, cconstant, cvariable, pot_heights, repfactor=1.2, breachfactor=0.2,
                 htunit="m +MSL", costunit='Million', slope=0.25, irribaren=3, core="clay", layermat="sand", layerthick=1, add_strength=1.0,
                 ):
        """
        ...
        :param ht_fail:
        """
        StructuralMeasure.__init__(self, name, layer, loc, cconstant, cvariable, pot_heights, repfactor, breachfactor,
                                   htunit)
        self.CostUnits = costunit
        self.Slope = slope
...
class StructuralMeasureWater(StructuralMeasure):
    ...
    def __init__(self, name, layer, loc, cconstant, cvariable, pot_heights, repfactor=1.2, breachfactor=1.0, htunit = 'm', slope=1,
                 irribaren=5.0, barriermat="steel", add_strength=1.8):
        """
...
class NatureBased(object):
    ...
    def __init__(self, name, loc, effect, factor, cost):
        """
...
class EmergencyMeasure(object):
    ...
    def __init__(self, name, change_basins, effect, cost):
...
class DrainageMeasure(object):
    ...
    def __init__(self, name, change_basins, cost):
